function [cROIs, Cs, cROIs_BG, Cs_BG, coherence, skew, sz, patchID, tElapsed, dimensions] = mcb_DNMF(paths_to_videos, options)
    % [cROIs, Cs, cROIs_BG, Cs_BG, coherence, skew, sz, patchID, tElapsed, dimensions] = mcb_DNMF(path_to_video, options)
    %
    % Jason Moore, 2025
    
    if(~iscell(paths_to_videos))
    ...
    [cROIs0, Cs0, cROIs_BG, Cs_BG, coherence0, skew0, sz0, patchID0] = DNMF_General(paths_to_videos, options);
